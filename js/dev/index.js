...
function initSliders() {
  if (document.querySelector(".tab-body__slider")) {
    new Swiper(".tab-body__slider", {
      ...
      on: {
        slideChange: function() {
          ...
          this.slides.forEach((slide2, index) => {
            slide2.classList.remove("tab-body__slide--activ");
            const oldContent = slide2.querySelector(".tab-body__content");
            if (oldContent) oldContent.remove();
            if (index === activeIndex) {
              slide2.classList.add("tab-body__slide--activ");
              const contentBlock = document.createElement("div");
              contentBlock.className = "tab-body__content";
              contentBlock.innerHTML = `<h4 class="tab-body__subtitle">Hotel Quality Pillow</h4>
        															<a class="tab-body__desc --icon-cart" href="#">125$</a>`;
              slide2.appendChild(contentBlock);
            }
          });
        },
        init: function() {
        ...
        <h4 class="tab-body__subtitle">Hotel Quality Pillow</h4>
        <a class="tab-body__desc --icon-cart" href="#">125$</a>
      `;
              slide2.appendChild(contentBlock);
            }
